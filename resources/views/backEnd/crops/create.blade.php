...
@section('content')
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body">
                {{Form::open(['route'=>['CropsStore'],'method'=>'POST', 'files' => true ])}}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('color','', array('placeholder' => '','class' => 'form-control','id'=>'color','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="title_ar"
                    ...
                    <div class="col-sm-10">
                        {!! Form::select('quantity',[''=>'اختر وحدة','طن'=>'طن','اردب'=>'اردب'], '',array('class' => 'form-control','id'=>'quantity','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="title_ar"
                    ...
                    <div class="col-sm-10">
                        {!! Form::select('area',[''=>'اختر وحدة','فدان'=>'فدان','هيكتار'=>'هيكتار'], '',array('class' => 'form-control','id'=>'area','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="file_ar"
