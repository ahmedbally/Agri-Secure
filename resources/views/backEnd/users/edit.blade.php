    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group row">
                    <label for="mobile"
                           class="col-sm-2 form-control-label">الموبايل
                    </label>
                    <div class="col-sm-10">
                        {!! Form::text('mobile',$Users->mobile, array('placeholder' => '','class' => 'form-control','id'=>'mobile','required'=>'')) !!}
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::password('connect_password',$Users->connect_password, array('placeholder' => '','class' => 'form-control','id'=>'connect_password')) !!}
                    </div>
                </div>
