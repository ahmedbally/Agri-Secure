        ...
        <div class="box nav-active-border b-info">
            ...
            <div class="tab-content clear b-t">
                <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                    <div class="box-body">
                        {{Form::open(['route'=>['topicsUpdate',"webmasterId"=>$WebmasterSection->id,"id"=>$Topics->id],'method'=>'POST', 'files' => true, 'id' => 'myForm'])}}
                                        ...
                                        @if($Topics->video_type==0 && $Topics->video_file!="")
                                            <div class="box p-a-xs">
                                                ...
                                                <video width="380" height="230" controls>
                                                    <source src="{{ URL::to('uploads/topics/'.$Topics->video_file) }}" type="video/mp4">
                ...
                icons: {
                  ...
                  <span class="fa fa-calendar"></span>
                        ...
                        <div class="form-group row m-t-md">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" class="btn btn-primary m-t" id="ajax_up"><i class="material-icons">
...
@section('footerInclude')
    ...
    @if($WebmasterSection->attach_file_status)
    <script src="{{ URL::to('backEnd/libs/jquery/jquery.form.js') }}"></script>
    <script>
        $(document).ready(function()
                {
             ...
             var options = { 
                    ...
                    complete: function(response) 
                    {
                        ...
                        if (response.responseJSON.status==true) {
                            ...
                            $("#message").html("<font color='green'><div style='height:auto;'>"+response.responseJSON.message+"</div></font>");
                        }
                    },
                    error: function()
                    {
    ...
    <style>
        #progress { position:relative; width:100%; height:20px; border: 1px solid #ddd; padding: 1px; border-radius: 3px; }
        #bar { background-color: #317907; width:0%; height:15px; border-radius: 3px; padding-bottom:10px; }
        #percent { position:absolute;top:0px; left:48%; }
    </style>
    @endif
@endsection