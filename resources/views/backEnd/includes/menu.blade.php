...
<div id="aside" class="app-aside modal fade folded md nav-expand">
    <div class="left navside dark dk" layout="column">
        ...
        <div flex class="hide-scroll" id="boxscroll" ui-jp="niceScroll" ui-options="{cursorborder:'',cursorcolor:'#808a93',cursoropacitymin:'1'}">
            <nav class="scroll nav-active-primary">
                ...
                <ul class="nav" ui-nav>
                  ...
                  <span class="nav-icon">
                            ...
                            @if($GeneralWebmasterSection->sections_status > 0)
                                <li {{ ($GeneralWebmasterSection->id == @$WebmasterSection->id && $is_webmaster != "webmaster") ? 'class=active' : '' }}>
                                    ...
                                    <ul class="nav-sub">
                                        ...
                                        @endif
                                        @if($GeneralWebmasterSection->id!=14 && $GeneralWebmasterSection->id!=16)
                                        <?php
                                        ...
                                        @endif
                                        @if($GeneralWebmasterSection->id==16)
                                            <?php
                                            $currentFolder = "import"; // Put folder name here
                                            $PathCurrentFolder = substr($urlAfterRoot,
                                                (strlen($GeneralWebmasterSection->id) + 1), strlen($currentFolder));
                                            ?>
                                            ...
                                            <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                                <a href="{{ route('import') }}">
                                                    <span class="nav-text">استيراد {!! str_replace("backLang.","",trans('backLang.'.$GeneralWebmasterSection->name)) !!}</span>
                                                </a>
                                            </li>
                                        @endif
                                    </ul>
                    ...
                    @endif
                    <?php
                    $currentFolder = "crops"; // Put folder name here
                    $PathCurrentFolder = substr($urlAfterRoot, 0, strlen($currentFolder));
                    $currentFolder2 = "cities_crops"; // Put folder name here
                    $PathCurrentFolder2 = substr($urlAfterRoot, 0, strlen($currentFolder2));
                    ?>

                    <li class="{{ ($PathCurrentFolder==$currentFolder || $PathCurrentFolder2==$currentFolder2) ? 'active' : '' }}">
                        <a>
                            <span class="nav-caret">
                                <i class="fa fa-caret-down"></i>
                            </span>
                            ...
                            <span class="nav-text">{{ trans('backLang.CitiesCrops') }}</span>
                        </a>
                        <ul class="nav-sub">
                            <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                            ...
                            <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                <a href="{{ route('Crops') }}">
                                    <span class="nav-text">{{ trans('backLang.Crops') }}</span>
                                </a>
                            </li>
                            <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                <a href="{{ route('Centers') }}">
                                    <span class="nav-text">ادارة المراكز</span>
                                </a>
                            </li>
							<li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                <a href="{{ route('CitiesCropsImportUI') }}">
                                    <span class="nav-text">استيراد قاعدة بيانات</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    @if(Helper::GeneralWebmasterSettings("settings_status"))
                        @if(@Auth::user()->permissionsGroup->settings_status)
                            ...
                            ?>
                            <li class="{{ ($PathCurrentFolder==$currentFolder || $PathCurrentFolder2==$currentFolder2 || $PathCurrentFolder3==$currentFolder3 ) ? 'active' : '' }}">
                                <a>
                                    <span class="nav-caret">
                                    <i class="fa fa-caret-down"></i>
                                    </span>
                                ...
                                <ul class="nav-sub">
                                    ...
                                    <?php
                                    if (env('devadmin') !=null && env('devadmin')) {
                    ...
                    @if(@Auth::user()->permissionsGroup->webmaster_status && env('devadmin') !=null && env('devadmin'))
                        <?php
                        ...
                        <li class={{ ($PathCurrentFolder==$currentFolder) ? 'active' : '' }}>
                            ...
                            <ul class="nav-sub">
                                ...
                                ?>
                                <li class={{ ($PathCurrentFolder==$PathCurrentSubFolder) ? 'active' : '' }}>
                                ...
                                ?>
                                <li class={{ ($PathCurrentSubFolder==$currentSubFolder) ? 'active' : '' }}>
