...
@section('content')
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body">
                {{Form::open(['route'=>['CitiesCropsStore'],'method'=>'POST', 'files' => true ])}}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::select('season',['اختر الموسم','بدون'=>'بدون','الشتوي'=>'الشتوي','الصيفي'=>'الصيفي','النيلي'=>'النيلي'], '',array('class' => 'form-control','id'=>'season','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="title_ar"
                    ...
                    <div class="col-sm-10">
                        {!! Form::select('crop',$Crops, '',array('class' => 'form-control','id'=>'crop','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="title_ar"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::select('center',[''=>'اختر المركز'], '',array('class' => 'form-control','id'=>'center','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="title_ar"
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('quantity','', array('placeholder' => '','class' => 'form-control','id'=>'quantity','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="title_ar"
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('area','', array('placeholder' => '','class' => 'form-control','id'=>'area','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="title_ar"
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('productivity','', array('placeholder' => '','class' => 'form-control','id'=>'productivity','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="title_ar"
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('year','', array('placeholder' => '','class' => 'form-control','id'=>'year','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                    </div>
                </div>
