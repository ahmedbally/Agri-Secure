                                ...
                                <div class="col-sm-10">
                                    <select name="father_id" id="father_id" class="form-control c-select">
                                        ...
                                        @foreach ($fatherSections as $fatherSection)
                                            ...
                                            ?>
                                            <option value="{{ $fatherSection->id  }}" {{ (($fatherSection->id == $Sections->father_id) || (!empty($level1Father->father_id) && $fatherSection->id == $level1Father->father_id)) ? "selected='selected'":""  }}>{{ $title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>

                            @if($WebmasterSection->id == 14 || $WebmasterSection->id == 14)
                            <div class="form-group row father_id_second" @if(empty($level1Father->father_id))style="display: none"; @endif>
                                <label for="father_id_second"
                                       class="col-sm-2 form-control-label">{!! trans('backLang.secondLevel') !!} </label>
                                <div class="col-sm-10" id="father_id_second">
                                    <select name="father_id_second" class="form-control c-select">
                                        <option value="0">- - {!!  trans('backLang.sectionNoFather') !!} - -</option>
                                        <?php
                                        $title_var = "title_" . trans('backLang.boxCode');
                                        $title_var2 = "title_" . trans('backLang.boxCodeOther');
                                        ...
                                        @foreach ($childSections as $childSection)
                                            <?php
                                            if ($childSection->$title_var != "") {
                                                $title = $childSection->$title_var;
                                            } else {
                                                $title = $childSection->$title_var2;
                                            }
                                            ?>
                                            <option value="{{ $childSection->id  }}" {{ ($childSection->id == $Sections->father_id) ? "selected='selected'":""  }}>{{ $title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        @else
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="box p-a-xs">
                                            {!! Form::textarea('details_ar',$Sections->details_ar, array('ui-jp'=>'summernote','placeholder' => '','class' => 'form-control summernote_ar', 'dir'=>trans('backLang.rtl'),'ui-options'=>'{height: 300,callbacks: {
                            ...
                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="box p-a-xs">
                                            {!! Form::textarea('details_en',$Sections->details_en, array('ui-jp'=>'summernote','placeholder' => '','class' => 'form-control summernote_en', 'dir'=>trans('backLang.ltr'),'ui-options'=>'{height: 300,callbacks: {
                                                onImageUpload: function(files, editor, welEditable) {
