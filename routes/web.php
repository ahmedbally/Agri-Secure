...
Route::Group(['prefix' => env('BACKEND_PATH'), 'middleware' => ['web','auth','XSS'],'before' => 'csrf'], function () {
    ...
    Route::get('/centers/create', 'CentersController@create')->name('CentersCreate');
    Route::post('/centers/store', 'CentersController@store')->name('CentersStore');
    Route::get('/centers/{id}/edit', 'CentersController@edit')->name('CentersEdit');
    Route::post('/centers/{id}/update', 'CentersController@update')->name('CentersUpdate');
    Route::get('/centers/destroy/{id}', 'CentersController@destroy')->name('CentersDestroy');
    Route::post('/centers/updateAll', 'CentersController@updateAll')->name('CentersUpdateAll');

    Route::get('/crops', 'CropsController@index')->name('Crops');
    Route::get('/crops/create', 'CropsController@create')->name('CropsCreate');
    Route::post('/crops/store', 'CropsController@store')->name('CropsStore');
    Route::get('/crops/{id}/edit', 'CropsController@edit')->name('CropsEdit');
    Route::post('/crops/{id}/update', 'CropsController@update')->name('CropsUpdate');
    Route::get('/crops/destroy/{id}', 'CropsController@destroy')->name('CropsDestroy');
    Route::post('/crops/updateAll', 'CropsController@updateAll')->name('CropsUpdateAll');

    Route::get('/cities_crops', 'CitiesCropsController@index')->name('CitiesCrops');
    Route::get('/cities_crops/import', 'CitiesCropsController@import')->name('CitiesCropsImportUI');
    Route::get('/cities_crops/create', 'CitiesCropsController@create')->name('CitiesCropsCreate');
    Route::post('/cities_crops/upload', 'CitiesCropsController@upload')->name('CitiesCropsImport');
    Route::post('/cities_crops/store', 'CitiesCropsController@store')->name('CitiesCropsStore');
    Route::get('/cities_crops/{id}/edit', 'CitiesCropsController@edit')->name('CitiesCropsEdit');
    Route::post('/cities_crops/{id}/update', 'CitiesCropsController@update')->name('CitiesCropsUpdate');
    ...
    Route::get('/16/import', 'SectionsController@import')->name('import');
    Route::post('/16/import', 'SectionsController@upload')->name('databaseImport');
    // Topics
