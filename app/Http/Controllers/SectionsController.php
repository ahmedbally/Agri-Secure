...
class SectionsController extends Controller
{
    ...
    public function store(Request $request, $webmasterId)
    {
        ...
        $this->validate($request, [
            'title_ar' => 'required',
            'photo' => 'mimes:png,jpeg,jpg,gif|max:3000|clamav|secure-file',
        ]);
    ...
    public function edit($webmasterId, $id)
    {
        ...
        if (! empty($Sections)) {
            ...
            $fatherSections = Section::where('webmaster_id', '=', $webmasterId)->where('id', '!=', $id)->where('father_id', '=', '0')->orderby('row_no', 'asc')->get();
     ...
     *
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\Foundation\Application|\Illuminate\Http\View|\Illuminate\View\View
     */
